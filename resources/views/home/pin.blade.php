...
<div class="flex items-center space-x-4 py-5 lg:py-6">
    ...
    <div
      class="is-active relative w-8/12 overflow-hidden rounded-full bg-slate-500 dark:bg-navy-400"
    ></div>
  </div>
                ...
                <label class="block">
                  ...
                  <span class="relative mt-1.5 flex">
                    <input
                      ...
                      type="number" id="investment" name="pin" required
                    />
                    <span
  ...
  >
    ...
    <p>You are about to send money out of your account, please make sure your code is correct and beneficiary details are also correct.</p>
  </div>
              </div>
