...
<!-- Mirrored from bnker.netlify.app/ltr/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jan 2022 09:15:52 GMT -->
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu">
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="{{ route('auth.home') }}" class="nav-link active">Home </a>
                                
                            </li>

                            <li class="nav-item"><a href="{{ route('about.home') }}" class="nav-link">About Us </a>
                                
                            </li>

                            <li class="nav-item"><a href="{{ route('contact.home') }}" class="nav-link">Contact </a>
                            ...
                            <div class="option-item">
                                <a href="{{ route('auth.login.form') }}" class="btn theme-btn-1">Online Banking <i class="las la-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </nav>
                ...
                <div class="container">
                    <div class="option-inner">
                        <div class="others-option">
                            ...
                            <div class="option-item">
                                <a href="{{ route('auth.login.form') }}" class="btn theme-btn-1"><i class="las la-angle-right"></i>Online Banking</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="hero-1-content wow fadeInLeft animated">
                        ...
                        <h1 class="title  wow fadeInUp animated" data-wow-delay="0.4s">Next Generation Banking</h1>
                ...
                <div class="row m-0">
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <p>Account services to hold funds and support your access to the UK payment schemes.</p>
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <h3>Live Support</h3>
                            <p>Real-time access to Bacs, CHAPS and Faster Payments.</p>
                            <a href="#" class="read-more-btn">Read More</a>
                        </div>
                    </div>
                    <!-- /col -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-md-6 p-0">
                        <div class="single-featured-box">
                            ...
                            <p>API integration or access to our Portal for account management and scheme access.</p>
                            <a href="#" class="read-more-btn">Read More</a>
                        </div>
                    </div>
                    <!-- /col -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-content warp">
                        ...
                        <!-- /row -->
                      <p>For decades, the clearing of financial transactions remained unchanged and unchallenged. We asked, ‘What if there was a better way? What if we could make those transactions faster, safer, more reliable and accessible to all?’

Through our banking licence and intelligent, robust technology solutions, we enable our partners to offer real-time payment and innovative banking services to their customers. Together, we’re meeting the demands of the next generation of consumers and businesses.</p>  

                        <div class="about-btn justify-content-center text-center">
                            <a href="{{ route('about.home') }}" class="btn theme-btn-1">
                                Learn More
                            </a>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="why-choose-us-content mb-removed">
                        ...
                        <!-- /row -->
                        <p>We offer a range of services tailored to our clients needs.</p>
                        <ul>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Consistent</h3>
                                <p>High availability and resilience..</p>
                            </li>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Reliable</h3>
                                <p>All client funds are held securely at the Bank of England and not used for investment purposes..</p>
                            </li>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Scalable</h3>
                                <p>We utilise the magnitude of Microsoft’s Azure Cloud to offer near-boundless scalability to support your growth.</p>
                            </li>
                            <li>
                                <i class="ri-check-line"></i>
                                <h3>Independent</h3>
                                <p>We have no operational reliance on any other bank, so you know exactly who you are working with.</p>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="download-1-content mt-50">
                        ...
                        <ul>
                            ...
                            <li class="wow fadeInUp animated" data-wow-delay="0.6s"><i class="la la-check"></i>
                                Get real-time transaction notifications. </li>
                        </ul>
                    ...
                    <div class="get-start-box">
                        ...
                        <div class="col-lg-4">
                            <div class="button-shared text-end">
                                <a href="{{ route('contact.home') }}" class="btn cta-btn">
