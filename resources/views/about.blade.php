...
<!-- Mirrored from bnker.netlify.app/ltr/about-us-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jan 2022 09:18:20 GMT -->
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu">
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="{{ route('auth.home') }}" class="nav-link">Home </a>
                                
                            </li>

                            <li class="nav-item active"><a href="{{ route('about.home') }}" class="nav-link">About Us </a>
                ...
                <div class="container">
                    <div class="option-inner">
                        <div class="others-option">
                            ...
                            <div class="option-item">
                                <a href="{{ route('contact.home') }}" class="btn theme-btn-1"><i class="las la-angle-right"></i>Get
                                    Started</a>
                            </div>
                        </div>
                    </div>
...
Through our banking licence and intelligent, robust technology solutions, we enable our partners to offer real-time payment and innovative banking services to their customers. Together, we’re meeting the demands of the next generation of consumers and businesses..</p>
                        <div class="about-inner-content">
                            ...
                            <p>We are available on all platforms.</p>
                        </div>
                        <div class="about-inner-content">
                            <div class="icon">
                                <i class="las la-check"></i>
                            ...
                            <p>We provide tailore and world class marketing strategy for a wide range of clients.</p>
                        </div>
                        <div class="about-inner-content">
                            <div class="icon">
                                <i class="las la-check"></i>
                            ...
                            <p>We Assist small and medium scale enterprises achieve financial inclusivity and success.</p>
                        </div>
